...
import { codeDesc, sampleCode } from '@/utils/psbtwo';
...
function PsbTwoPage () {
  ...
  return (
    <Layout>
      <Header title="Fahmi | PSB Two"/>
      <div>
        <h1 className=' text-xl md:text-3xl font-bold pt-36 md:pt-44'>Problem Solving Basic - <span className='text-primary'>Test 2</span></h1>
        ...
        <div className='grid grid-cols-1 xl:grid-cols-3 gap-4'>
          {codeDesc.map((e, i) => (
            <div key={i}>
              ...
              <div className='border dark:border-gray-700 rounded-xl h-auto xl:h-[270px]'>
